...
public class FroyoLocationUpdateRequesterShould {
    ...
    final FroyoLocationUpdateRequester updateRequester = new FroyoLocationUpdateRequester(locationManager);
    ...
    public void request_passive_location_updates_using_the_passive_provider() throws Exception {
        ...
        updateRequester.requestPassiveLocationUpdates(settings, pendingIntent);
